...
public class SmithSmeltingBlockEntity extends BlockEntity implements ExtendedScreenHandlerFactory, ImplementedInventory {
    ...
    public SmithSmeltingBlockEntity(BlockPos pos, BlockState state) {
        super(ModBlockEntities.SMITH_SMELTING_BLOCK_ENTITY, pos, state);
        this.propertyDelegate = new PropertyDelegate() {
            @Override
            public int get(int index) {
                return switch (index){
                    case 0 -> SmithSmeltingBlockEntity.this.progress;
                    case 1 -> SmithSmeltingBlockEntity.this.maxProgress;
                    case 2 -> SmithSmeltingBlockEntity.this.fire;
                    case 3 -> SmithSmeltingBlockEntity.this.maxFire;
                    default -> 0;
                };
            }
            ...
            public void set(int index, int value) {
                switch (index){
                    case 0 -> SmithSmeltingBlockEntity.this.progress = value;
                    case 1 -> SmithSmeltingBlockEntity.this.maxProgress = value;
                    case 2 -> SmithSmeltingBlockEntity.this.fire = value;
                    case 3 -> SmithSmeltingBlockEntity.this.maxFire = value;
                }
            }
